...
const ProfileForm = ({ user }: ProfileFormProps) => {
  ...
  */
  ...
  const { mutate: createMutation } = useMutation(createProfile, { onSettled });
  const { mutate: updateMutation } = useMutation(updateProfile, { onSettled });
  const { mutate: deleteMutation } = useMutation(deleteProfile, { onSettled });
